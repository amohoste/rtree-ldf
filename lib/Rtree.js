...
class Rtree {
    ...
    toFragments(obj) {
        ...
        fs.writeFileSync(path.join(obj.outDir, obj.collection), JSON.stringify(createCollectionDescription(obj.collection, obj.manages, this.totalItems, path.join(obj.treeDir, `t${startTreePage}.jsonld`))));
